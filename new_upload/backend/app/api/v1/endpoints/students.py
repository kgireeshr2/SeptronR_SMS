...
from app.core.entitlements import enforce_student_seat_limit
...
@router.post("/", response_model=StudentDetailResponse, status_code=status.HTTP_201_CREATED, dependencies=[Depends(permission_required("students", "create")), Depends(enforce_student_seat_limit)])
...
@router.get("/", response_model=List[StudentResponse], dependencies=[Depends(permission_required("students", "view"))])
...
@router.get("/stats", response_model=StudentStats, dependencies=[Depends(permission_required("students", "view"))])
...
@router.get("/{student_id}", response_model=StudentDetailResponse, dependencies=[Depends(permission_required("students", "view"))])
...
@router.put("/{student_id}", response_model=StudentDetailResponse, dependencies=[Depends(permission_required("students", "edit"))])
...
@router.delete("/{student_id}", status_code=status.HTTP_200_OK, dependencies=[Depends(permission_required("students", "delete"))])
...
# ========== Parent Management ==========
@router.post("/{student_id}/parents", response_model=StudentParentResponse, dependencies=[Depends(permission_required("students", "edit"))])
...
@router.get("/{student_id}/parents", response_model=List[StudentParentResponse], dependencies=[Depends(permission_required("students", "view"))])
...
@router.delete("/parents/{parent_id}", status_code=status.HTTP_200_OK, dependencies=[Depends(permission_required("students", "edit"))])
...
@router.put("/parents/{parent_id}", response_model=StudentParentResponse, dependencies=[Depends(permission_required("students", "edit"))])
...
@router.post("/{student_id}/enrollments", response_model=StudentEnrollmentResponse, dependencies=[Depends(permission_required("students", "edit"))])
...
# ========== Document Management ==========
@router.post("/{student_id}/documents/upload", response_model=StudentDocumentResponse, status_code=status.HTTP_201_CREATED, dependencies=[Depends(permission_required("students", "edit"))])
...
@router.post("/{student_id}/documents", response_model=StudentDocumentResponse, dependencies=[Depends(permission_required("students", "edit"))])
...
@router.get("/{student_id}/documents", response_model=List[StudentDocumentResponse], dependencies=[Depends(permission_required("students", "view"))])
...
@router.delete("/documents/{document_id}", status_code=status.HTTP_200_OK, dependencies=[Depends(permission_required("students", "edit"))])
...
# ========== Photo Upload ==========
@router.post("/{student_id}/photo", dependencies=[Depends(permission_required("students", "edit"))])
...
# ========== Bulk Operations ==========
@router.post("/promote", response_model=List[StudentPromotionResponse], dependencies=[Depends(permission_required("students", "edit"))])
...
@router.post("/import", response_model=BulkImportResult, dependencies=[Depends(permission_required("students", "create"))])
async def bulk_import_students(
    ...
    Supports student details, class/section enrollment (current academic year),
    parent details (father/mother/guardian) and fee structure assignment.
    See the importer for the recognised column headers.
    """
...
@router.get("/export/csv", dependencies=[Depends(permission_required("students", "export"))])
...
@router.post("/{student_id}/transfer-certificate", response_model=StudentTransferResponse, dependencies=[Depends(permission_required("students", "edit"))])
...
@router.get("/{student_id}/transfer-certificate", response_model=StudentTransferResponse, dependencies=[Depends(permission_required("students", "view"))])
...
@router.get("/{student_id}/transfer-certificate/pdf", dependencies=[Depends(permission_required("students", "view"))])
...
# ========== ID Card Generation ==========
@router.get("/{student_id}/id-card", dependencies=[Depends(permission_required("students", "view"))])
...
@router.post("/id-cards/bulk", dependencies=[Depends(permission_required("students", "view"))])
