...
class TimetableService:
    ...
    async def get_timetable_pdf(self, section_id: str, year_id: str, school_id: str) -> bytes:
        grid = await self.timetable_repo.get_grid_for_section(section_id, year_id, school_id)
