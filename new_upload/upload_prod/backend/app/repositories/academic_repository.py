...
class AcademicYearRepository:
    ...
    async def get_by_id(self, year_id: str, school_id: Optional[str] = None) -> Optional[AcademicYear]:
        query = select(AcademicYear).where(AcademicYear.id == year_id)
...
class AcademicTermRepository:
    ...
    async def get_by_id(self, term_id: str, school_id: Optional[str] = None) -> Optional[AcademicTerm]:
        query = select(AcademicTerm).where(AcademicTerm.id == term_id)
        if school_id is not None:
