...
class TimetableRepository:
    ...
    async def get_grid_for_section(self, section_id: str, year_id: str, school_id: str) -> dict:
    ...
    async def get_teacher_schedule(self, teacher_id: str, year_id: str, school_id: str) -> list[dict]:
        result = await self.db.execute(
            select(
                Timetable,
                Subject.name,
    ...
    async def delete_entry(self, timetable_id: str, school_id: str) -> None:
        await self.db.execute(
            delete(Timetable).where(Timetable.id == timetable_id, Timetable.school_id == school_id)
        )
        await self.db.flush()
